...
```{r}
# params <- list(season_number = 1:8)

# Loop through each season number
for (season_number in params$season_number) {
  render("Assignment.qmd", 
         output_file = sprintf("Season_%s_Report.html", season_number),
         params = list(season_number = season_number))  # Ensure params is a named list
}
```
