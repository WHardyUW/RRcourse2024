---
title: "Meta-analysis on Toy Preferences: Study Year and Setting Effects"
author: ""
date: today
...
# Meta-analysis on Toy Preferences: Study Year and Setting Effects
...
In this assignment, we analyze data on children's toy preferences, specifically focusing on the effect of the year of study publication and the study setting (home, laboratory, nursery). The dataset includes mean times (in seconds) spent playing with toys, sample sizes, standard errors, and additional study characteristics.
...
### Checking the Effect of Study Year and Setting

We analyze whether the year of study publication and study setting affect the results using meta-regression.
...
meta_reg_year = smf.ols('TE_boys_male ~ Year + Setting', data=data).fit()
meta_reg_year.summary()
```
